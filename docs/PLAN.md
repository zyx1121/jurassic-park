...
> [!NOTE]
> 本節的數值以原版 6.3 地圖物件資料解析結果為唯一來源，完整清單在 [ORIGINAL_CONTENT.md](./ORIGINAL_CONTENT.md)：162 個單位、98 個物品、207 個技能、70 個科技、10 個可破壞物。腳本是混淆過的純 JASS，日夜長度等少數項目仍標 uncertain。
...
| 日夜 | 照原版；日夜週期長度與營火視野加成在腳本中尚未定位，見 `ORIGINAL_CONTENT.md` 的 uncertain 項 |
| 波次與事件 | 照原版：沒有固定波次表，而是 20 多組隨機區間週期計時器（1.4 到 750 秒）加生成候選區；照抄隨機性 |
