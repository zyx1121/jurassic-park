...
namespace JurassicPark.World
{
    ...
    public sealed class TerrainConfig : ScriptableObject
    {
        ...
        [Min(0.05f)] public float maxStepPerCell = 0.35f;
        ...
        [Range(0f, 1f)] public float rockSlope = 0.55f;
        ...
        [Range(0f, 1f)] public float dirtThreshold = 0.72f;
    }
}
